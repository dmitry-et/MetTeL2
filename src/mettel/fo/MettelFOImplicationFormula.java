...
public class MettelFOImplicationFormula extends MettelFOAbstractExpression implements MettelFOFormula{
    ...
    public MettelFOImplicationFormula(MettelFOFormula e0, MettelFOFormula e1, MettelFOObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(MettelFOExpression e, MettelFOSubstitution s){
        if(!(e instanceof MettelFOImplicationFormula)){ return false;}
        final MettelFOImplicationFormula ee = (MettelFOImplicationFormula)e;
        return e0.match(ee.e0, s) && e1.match(ee.e1, s);
    }

    public MettelFOExpression substitute(MettelFOSubstitution s){
        return factory.createImplicationFormula((MettelFOFormula)e0.substitute(s), (MettelFOFormula)e1.substitute(s));
    }

    public MettelFOExpression rewrite(MettelFOReplacement s){
        MettelFOExpression e = s.getFormula(this);
        if(e != null){ return e; }
        final MettelFOImplicationFormula ee = factory.createImplicationFormula((MettelFOFormula)e0.rewrite(s), (MettelFOFormula)e1.rewrite(s));
        e = s.getFormula(ee);
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof MettelFOImplicationFormula)){ return false; }
        MettelFOImplicationFormula e = (MettelFOImplicationFormula) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof MettelFOImplicationFormula)){ return PRIORITY - ((MettelFOAbstractExpression)e).priority(); }
        MettelFOImplicationFormula ee = (MettelFOImplicationFormula) e;
        int result = 0;
