...
public class MettelFOTrueFormula extends MettelFOAbstractExpression implements MettelFOFormula{

    static final int PRIORITY = 1;
    private final int LENGTH;

    public MettelFOTrueFormula(MettelFOObjectFactory f){
        super(f);
        int l = 1;
        LENGTH = l;
    }
    ...
    public boolean match(MettelFOExpression e, MettelFOSubstitution s){
        if(!(e instanceof MettelFOTrueFormula)){ return false;}
        return true;
    }
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof MettelFOTrueFormula)){ return false; }
        return true;
    }
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof MettelFOTrueFormula)){ return PRIORITY - ((MettelFOAbstractExpression)e).priority(); }
        return 0;
    }
