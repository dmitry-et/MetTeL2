...
public class MettelFOConjunctionFormula extends MettelFOAbstractExpression implements MettelFOFormula{
    ...
    public MettelFOConjunctionFormula(MettelFOFormula e0, MettelFOFormula e1, MettelFOObjectFactory f){
        super(f);
        int l = 1;
        this.e0 = e0;
        l += e0.length();
    ...
    public boolean match(MettelFOExpression e, MettelFOSubstitution s){
        if(!(e instanceof MettelFOConjunctionFormula)){ return false;}
        final MettelFOConjunctionFormula ee = (MettelFOConjunctionFormula)e;
        return e0.match(ee.e0, s) && e1.match(ee.e1, s);
    }

    public MettelFOExpression substitute(MettelFOSubstitution s){
        return factory.createConjunctionFormula((MettelFOFormula)e0.substitute(s), (MettelFOFormula)e1.substitute(s));
    }

    public MettelFOExpression rewrite(MettelFOReplacement s){
        MettelFOExpression e = s.getFormula(this);
        if(e != null){ return e; }
        final MettelFOConjunctionFormula ee = factory.createConjunctionFormula((MettelFOFormula)e0.rewrite(s), (MettelFOFormula)e1.rewrite(s));
        e = s.getFormula(ee);
    ...
    public boolean equals(Object o){
        ...
        if(!(o instanceof MettelFOConjunctionFormula)){ return false; }
        MettelFOConjunctionFormula e = (MettelFOConjunctionFormula) o;
    ...
    public int compareTo(MettelExpression e){
        ...
        if(!(e instanceof MettelFOConjunctionFormula)){ return PRIORITY - ((MettelFOAbstractExpression)e).priority(); }
        MettelFOConjunctionFormula ee = (MettelFOConjunctionFormula) e;
        int result = 0;
