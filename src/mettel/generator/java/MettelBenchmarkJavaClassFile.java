...
public class MettelBenchmarkJavaClassFile extends MettelJavaClassFile{
	...
	public void generateBody(){
		...
		appendLine("private static void printToCSV(MettelProverThread thread) throws IOException{");
			...
			appendLine("if (thread.finished()){");
				...
				appendLine("File resultFile;");
				appendLine("String resultOutput;");
				...
				appendLine("problemInfo[2] = resultFile.toString();");
		...
		appendLine("private static void fillCsvStatistics(String[] problemInfo){");
			...
			i++;
			appendLine("problemInfo[" + i + "] = pStat.getProperty(\"" + MettelProblemAnalyzerDefaultPropertiesNames.TOTAL_SYMBOLS_OCCURENCES + "\");");
			i++;
	...
	private String generateCSVHeader() {
		...
		header.append("\"" + MettelProblemAnalyzerDefaultPropertiesNames.TOTAL_SYMBOLS_OCCURENCES + "\", ");
